...
const CONTENT_FR = {
  ...
  details: {
    ...
    dynamizer: {
      ...
      prob1: { title: 'Faible biodisponibilité cellulaire', text: 'Les traitements industriels altèrent la structure moléculaire de l\'eau, créant des "gros clusters" que nos cellules absorbent difficilement.' },
      prob2: { title: 'Eau déstructurée', text: 'À l\'état naturel, l\'eau a une structure hexagonale parfaite, clé d\'une hydratation optimale. Cette structure est malheureusement détruite lors de son acheminement vers notre robinet.' },
      solutionTitle: 'La Solution',
      sol1: { title: 'Restructuration et revitalisation', text: 'Fragmente les gros clusters en micro-clusters, rendant l\'eau hautement biodisponible. En même temps, il lui redonne sa structure hexagonale naturelle.' },
      sol2: { title: 'Transformation du calcaire', text: 'Through permanent magnets and extreme turbulence, it converts hard Calcite (responsible for deposits) into soft Aragonite. This form of limestone is non-scaling, thus protecting your appliances and pipes without altering the water\'s taste.' },
      sol3: { title: 'Stabilisation durable', text: 'L\'eau dynamisée acquiert une structure biologiquement stable qui se maintient dans le temps.' },
      pipeStraight: { title: 'Tube droit :', text: 'L\'eau s\'agglutine et perd sa puissance biophysique.' },
      pipeSpiral: { title: 'Tube en spirale :', text: 'Les clusters moléculaires sont dissous et l\'eau retrouve sa puissance biophysique.' },
      benefitsTitle: 'Bénéfices au quotidien',
      benefit1: { title: 'Goût exceptionnel', text: 'Découvrez une eau douce, remarquablement digeste et agréable.' },
      benefit2: { title: 'Hydratation cellulaire optimale', text: 'Favorise le bon fonctionnement du corps et réduit l\'acidité, source de nombreux déséquilibres.' },
      benefit3: { title: 'Protection naturelle anti-calcaire', text: 'Protège naturellement vos appareils et surfaces sans utiliser de sel ni produits chimiques.' },
      benefit4: { title: 'Performance inégalée', text: 'Avec une capacité de 5 000 litres/heure, le dynamiseur répond aux besoins de toute la maison.' },
