...
// --- PRODUCT CONSTANTS ---
const PRODUCT_ID = 'mam-nature-water-treatment-complete-set';
const PRODUCT_NAME = "COMPLETE SET";

const PRICE_MAP: Record<string, number> = {
  Morocco: 31241,    // MAD
  Switzerland: 2780, // CHF
  Europe: 2998       // EUR (Default)
};
...
export default function CompleteSetPage() {
  ...
  const IMAGES = [
    "https://nqhluawiejltjghgnbwl.supabase.co/storage/v1/object/public/website-assets/PRODUCT/COMPLETE%20SET.png", 
  ...
  // Helper for report URLs (kept consistent)
  const reportUrls = [
          ...
          <div className={styles.detailsList}>
            ...
            <div className={styles.accordionItem}>
              <button className={styles.accordionHeader} onClick={() => toggleAccordion('dynamizer')}>
                <div className={styles.headerGrid}>
                  <img src="https://nqhluawiejltjghgnbwl.supabase.co/storage/v1/object/public/website-assets/PRODUCT/DYNAMIZER.png" alt="Dynamizer" className={styles.headerImage} />
                  <div className={styles.accordionTitle}>
