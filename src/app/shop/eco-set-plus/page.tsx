...
// --- PRODUCT CONSTANTS ---
const PRODUCT_ID = 'mam-nature-eco-set-plus';
const PRODUCT_NAME = "ECO SET PLUS";

const PRICE_MAP: Record<string, number> = {
  Morocco: 19989,    // MAD
  Switzerland: 1787, // CHF
  Europe: 1916       // EUR (Default)
};
...
const CONTENT_EN = {
  ...
  product: {
    ...
    btnAdd: 'Add to Cart',
    features: [
      'Made of medical grade stainless steel, 10-year warranty, designed to last a lifetime',
      'Exceptional water for your whole home: Shower, drinking, cooking, Tea, Coffee…',
      'Treats: particles, limescale and contaminants (95 – 99.9%) while preserving natural mineralization',
      'No electricity, no waste, and no chemicals',
      'Maintenance: only one cartridge per year, 10 minutes (tool-free)'
    ]
  },
  usages: {
...
export default function EcoSetPlusPage() {
