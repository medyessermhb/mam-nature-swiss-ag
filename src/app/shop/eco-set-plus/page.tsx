  ...
  details: {
    ...
    lime: {
      ...
      content: {
        ...
        limits: 'Salt-based water softeners exchange calcium and magnesium ions for sodium, removing minerals (demineralized water is dangerous to health), thus the composition and taste of the water are seriously altered, requires regular & expensive maintenanceand causes an inadmissible bacterial load.',
...
export default function EcoSetPlusPage() {
  ...
  const IMAGES = [
    "/images/products/autobackwash/eco_set_plus_aqmos_auto_backwash.webp",
